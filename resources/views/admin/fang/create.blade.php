        ...
        <form class="form form-horizontal" id="form-article-add" action="{{ route('admin.fang.store') }}" method="post">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" value="{{ old('fang_name') }}" class="input-text" name="fang_name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小区名称：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{ old('fang_xiaoqu') }}" name="fang_xiaoqu">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <span class="select-box" style="width: 362px;">
                        <input type="text" class="select" value="{{ old('fang_addr') }}" placeholder="房源详细地址" name="fang_addr">
                    </span>
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 362px;">
                        <input type="text" class="select" value="{{ old('fang_build_area') }}" placeholder="房源面积" name="fang_build_area">
                    </span>
                    <span class="select-box" style="width: 362px;">
                        <input type="text" class="select" value="{{ old('fang_using_area') }}" placeholder="使用面积" name="fang_using_area">
                    </span>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 362px;">
                        <input type="text" class="select" placeholder="建筑年代" value="{{ old('fang_year') }}" name="fang_year">
                    </span>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 362px;">
                        <input type="text" value="{{ old('fang_rent') }}" class="select" name="fang_rent">
                    </span>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 80px;">
                        <input type="text" class="select" value="{{ old('fang_floor') }}" placeholder="房源楼层" name="fang_floor">
                    </span>
                    <span class="select-box" style="width: 150px;">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="fang_desn" class="textarea">{{ old('fang_desn') }}</textarea>
                </div>
            </div>
            <div class="row cl">
