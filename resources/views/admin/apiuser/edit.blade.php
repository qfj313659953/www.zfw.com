...
@section('content')
    ...
    <nav class="breadcrumb">
        ...
        <span class="c-gray en">&gt;</span> 接口账号修改
    ...
    <article class="page-container" id="app">
        ...
        <form class="form form-horizontal" id="form-apiuser-edit" method="post" @click="dopost" action="{{ route('admin.apiuser.update',$apiuser) }}">

            <input type="hidden" id="list" value="{{ $apiuser }}">
            <div class="row cl">
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    ...
                    <button class="btn btn-primary radius" type="button">修改接口账号</button>
        ...
        new Vue({
            ...
            methods : {
               ...
               loadData() {
                   ...
                   this.formData.password = this.formData.plainpass;
                },
