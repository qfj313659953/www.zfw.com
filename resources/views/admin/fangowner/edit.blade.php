...
@section('content')
    ...
    <nav class="breadcrumb">
        ...
        <span class="c-gray en">&gt;</span> 房源属性修改
    ...
    <article class="page-container">
        ...
        <form class="form form-horizontal" id="form-fangattr-add" method="post" action="{{ route('admin.fangAttr.update',$fangAttr)}}">
            @csrf
            @method('put')
            <div class="row cl">
				...
				<select name="pid" id="pid" class="select">
                    @foreach($attrpid as $id=>$name)
                        <option @if ($id == $fangAttr->pid) selected @endif value="{{ $id }}">{{ $name }}</option>
                    @endforeach
				</select>
				</span> </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{ $fangAttr->name }}" placeholder="" name="name">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">字段名称：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{ $fangAttr->field_name }}" placeholder="" name="field_name">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div class="uploader-thum-container">
                        ...
                        <div class="imgbox" @if($fangAttr->icon)style="display: block"@endif>
                            <input type="hidden" value="{{ $fangAttr->icon }}" name="icon" id="pic">
                            <img src="{{ $fangAttr->icon }}"  style="width: 100px;" alt="" id="showpic">
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    ...
                    <button class="btn btn-primary radius" type="submit">修改房源属性</button>
